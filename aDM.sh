...
sudo rm -rf /var/lib/tomcat/webapps/news/*
...
rsync -rtlvz --exclude 'wtshop.properties'  /root/learngit/wtshop/wtshop-web/target/wtshop-web/*    /var/lib/tomcat/webapps/news
rsync -rtlvz /root/news/wtshop.properties /var/lib/tomcat/webapps/news/WEB-INF/classes
