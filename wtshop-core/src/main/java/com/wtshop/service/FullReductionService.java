...
public class FullReductionService extends BaseService<FullReduction> {
	 ...
	 * 
	 */
	public FullReduction save(FullReduction promotion) {
	 ...
	 * 
	 */
	public FullReduction update(FullReduction promotion) {
	...
	public void delete(FullReduction promotion) {
