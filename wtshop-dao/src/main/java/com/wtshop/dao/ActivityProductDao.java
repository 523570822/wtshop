 ...
 */
public class ActivityProductDao extends BaseDao<ActivityProduct> {
     ...
     * @return
     */
    public List<ActivityProduct> findByActivityId(Long fuDaiId){
       String sql = "select * from activity_product where is_main=0 AND activity_id="+fuDaiId;
       return modelManager.find(sql);
    }
    public ActivityProduct findMainByFuDaiId(Long fuDaiId){
        String sql = "select * from activity_product where is_main=1 AND fudai_id="+fuDaiId;
