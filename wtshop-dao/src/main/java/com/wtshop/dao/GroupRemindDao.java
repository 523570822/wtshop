...
public class GroupRemindDao extends BaseDao<GroupRemind> {
    ...
    public List<GroupRemind> findByBrandId(Long brandId) {
        if (brandId == null) {
            return null;
        } else {
     ...
     * 新品推荐
     */
    public List<GroupRemind> findLikeList() {
     ...
     * 获取满减促销商品列表
     */
    public List<GroupRemind> findGoodsByPromId(Long promId) {
        if (promId == null) {
            return null;
        } else {
     ...
     * 获取满减促销商品列表
     */
    public Page<GroupRemind> findGoodsByPromId(Long promId, Pageable pageable) {
        if (promId == null) {
            return null;
        } else {
     ...
     */
    public List<GroupRemind> findCartItemList(Long id) {
     ...
     * 新品推荐
     */
    public List<GroupRemind> findNewGoodsList() {
     ...
     * 新品推荐
     */
    public List<GroupRemind> findCharactersList() {
     ...
     * 销量由高到低
     */
    public Page<GroupRemind> findSell(Pageable pageable, String keyword) {
     ...
     * 评论由高到低
     */
    public Page<GroupRemind> findReview(Pageable pageable, String keyword) {
     ...
     * 综合排序
     */
    public Page<GroupRemind> findTime(Pageable pageable, String keyword) {
     ...
     * vip商品分页
     */
    public Page<GroupRemind> findVipPage(Pageable pageable) {
     ...
     * 搜索功能
     */
    public Page<GroupRemind> search(Boolean is_vip, List<Long> productCategoryList, Long[] brandId, List<Long> areaList, Long[] functionId, String keyword, BigDecimal startPrice, BigDecimal endPrice, Pageable pageable, Boolean modify_date, Boolean sell, Boolean review, Boolean priceUp, Boolean priceDown) {
    ...
    public List<GroupRemind> findGoodsByItemId(Long id) {
    ...
    public List<GroupRemind> findGoodsByOrderItemId(Long id) {
    ...
    public List<GroupRemind> findGoodsByOrderId(Long orderId) {
    ...
    public List<GroupRemind> findGoodsByPt(Long id) {
     ...
     * 根据专题id获取商品信息
     */
    public List<GroupRemind> findGoodsByGoodsThemeId(Long id) {
    ...
    public GroupRemind findGoodsByCartItemId(Long id) {
     ...
     * 根据购物车id查找商品
     */
    public GroupRemind findGoodsByCartId(Long id) {
    ...
    public List<GroupRemind> findGoodsByFlashType() {
    ...
    public GroupRemind findGoodsByPro(Long productId) {
    ...
    public List<GroupRemind> findGoodsByProduct(Long productId) {
    ...
    public GroupRemind findGoodsByProductId(Long fudaid) {
    ...
    public List<GroupRemind> findGoodsByReverseId(Long id) {
     ...
     * 根据goods id 查询商品信息
     */
    public GroupRemind findGoodsById(Long id) {
     ...
     * 凑单shangpin
     */
    public Page<GroupRemind> findGoods(String price, Pageable pageable) {
     ...
     * @return
     */
    public GroupRemind findGoods(Long id) {
     ...
     */
    public GroupRemind findBySn(String sn) {
        if (StringUtils.isEmpty(sn)) {
            return null;
        }
     ...
     * @return 货品
     */
    public List<GroupRemind> findList(Goods.Type type, ProductCategory productCategory, Brand brand, Promotion promotion, Tag tag, Map<Attribute, String> attributeValueMap, BigDecimal startPrice, BigDecimal endPrice, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isOutOfStock,
     ...
     * @return 货品
     */
    public List<GroupRemind> findList(ProductCategory productCategory, Boolean isMarketable, Goods.GenerateMethod generateMethod, Date beginDate, Date endDate, Integer first, Integer count) {
        String sql = "SELECT * FROM goods g WHERE 1 = 1 ";
        if (productCategory != null) {
            sql += " AND EXISTS (SELECT 1 FROM product_category p WHERE g.product_category_id = p.id AND (p.`tree_path` LIKE '%" + ProductCategory.TREE_PATH_SEPARATOR + productCategory.getId() + ProductCategory.TREE_PATH_SEPARATOR + "%' OR g.product_category_id = " + productCategory.getId() + ")) ";
        }
     ...
     * @return 货品分页
     */
    public Page<GroupRemind> findPage(Boolean is_vip, Boolean is_delete, Goods.Type type, ProductCategory productCategory, Brand brand, Promotion promotion, Tag tag, Map<Attribute, String> attributeValueMap, BigDecimal startPrice, BigDecimal endPrice, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isOutOfStock,
    ...
    public Page<GroupRemind> findPage(Boolean is_vip, Boolean is_delete, Goods.Type type, List<Long> productCategory, Brand brand, Promotion promotion, Tag tag, Map<Attribute, String> attributeValueMap, BigDecimal startPrice, BigDecimal endPrice, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isOutOfStock,
                                Boolean isStockAlert, Boolean hasPromotion, Goods.OrderType orderType, Pageable pageable) {
        String sqlExceptSelect = "FROM goods g WHERE 1 = 1 ";
        String select = "select g.id,g.name,g.price,g.market_price,g.image,g.caption,g.product_category_id ";
    ...
    public Page<GroupRemind> findPage(Pageable pageable, List<Long> goodsList) {
     ...
     * @return 货品分页
     */
    public Page<GroupRemind> findPage(Goods.RankingType rankingType, Pageable pageable) {
     ...
     * @return 收藏货品分页
     */
    public Page<GroupRemind> findPage(Member member, Pageable pageable, String keyword) {
        if (member == null) {
            return null;
        }
    ...
    public List<GroupRemind> findBymemGroup(Long memid, Long groupid) {
        String sql = " select *  from group_remind g where g.group_id="+groupid+"  and member_id="+memid+" ";
        return modelManager.find(sql);
     ...
     * 获取提箱数量
     */
    public List<GroupRemind> findListNum(Double hour){
        hour=hour*60;
        String sql = "select  gr.*,count(gr.id) number   from group_remind gr LEFT JOIN group_buy g on g.id =gr.group_id where gr.`status`=2 and (now()-date_sub(g.begin_date, interval "+hour+" minute))>0  GROUP BY gr.member_id";
        return modelManager.find(sql);
    }
}