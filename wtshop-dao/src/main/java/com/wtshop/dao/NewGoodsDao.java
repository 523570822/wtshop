 ...
 */
public class NewGoodsDao extends BaseDao<NewgoodsCommend> {
     ...
     * 分页
     */
    public Page<NewgoodsCommend> findPages(Pageable pageable, String name, String sn){

        String sql = "from newGoods_commend c left join goods g on c.goods_id = g.id LEFT JOIN product_category p on g.product_category_id = p.id where 1 = 1  ";
