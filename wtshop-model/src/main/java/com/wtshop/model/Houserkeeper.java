...
import com.wtshop.model.base.BaseHouserkeeper;
...
public class Houserkeeper extends BaseHouserkeeper<Houserkeeper> {
	public static final Houserkeeper dao = new Houserkeeper().dao();
	/** 会员 */
