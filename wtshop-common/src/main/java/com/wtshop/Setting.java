...
public class Setting implements Serializable {
	...
	/** 是否开启包邮设置 */
	private Boolean isFreeMoney;

	/** 普通订单付款时间 */
	private Integer commomPayTime;

	/** 正品保障文案 */
	private String certifiedCopy;

	/** 首页赠送喵币图片 */
	private String sendMiaoBiImg;
	...
	/** 购物须知访问地址 */
	private String shoppingCopyUrl;
	...
	/** 退换货保险访问地址 */
	private String returnCopyUrl;

	/** 是否开启喵币抵扣 */
	private Boolean isUseMiaoBi;
	...
	/** 喵币赠送比例 */
	private Double sendMiaoBiLimit;
	...
	/** 店铺佣金 */
	private Double organCommission;

	/** 是否开启注册赠送喵币 */
	private Boolean isRegisterSending;
	...
	public String getSendMiaoBiImg() {
		return sendMiaoBiImg;
	}

	public void setSendMiaoBiImg(String sendMiaoBiImg) {
		this.sendMiaoBiImg = sendMiaoBiImg;
	}

	public void setIsRegisterSending(Boolean isRegisterSending) {
		this.isRegisterSending = isRegisterSending;
	}

	public Boolean getIsRegisterSending(){
	...
	public Double getRegisterSending() {
		return registerSending;
	}

	public void setRegisterSending(Double registerSending) {
		this.registerSending = registerSending;
	}
	...
	public Double getOrganCommission() {
		return organCommission;
	}

	public void setOrganCommission(Double organCommission) {
		this.organCommission = organCommission;
	}
	...
	public Boolean getIsStaffMessage() {
		return isStaffMessage;
	}

	public void setIsStaffMessage(Boolean staffMessage) {
		this.isStaffMessage = staffMessage;
	}

	public void setIsFreeMoney(Boolean isFreeMoney) {
		this.isFreeMoney = isFreeMoney;
	}

	public Boolean getIsFreeMoney(){
		return isFreeMoney ;
	}

	public Boolean getIsReturnInsurance() {
		return isReturnInsurance;
	}

	public void setIsReturnInsurance(Boolean isReturnInsurance) {
		this.isReturnInsurance = isReturnInsurance;
	}

	public Boolean getIsUseMiaoBi() {
		return isUseMiaoBi;
	}

	public void setIsUseMiaoBi(Boolean isUseMiaoBi) {
		this.isUseMiaoBi = isUseMiaoBi;
	}

	public Integer getCommomPayTime() {
		return commomPayTime;
	}

	public void setCommomPayTime(Integer commomPayTime) {
		this.commomPayTime = commomPayTime;
	}
	...
	public String getShoppingCopyUrl() {
		return shoppingCopyUrl;
	}

	public void setShoppingCopyUrl(String shoppingCopyUrl) {
		this.shoppingCopyUrl = shoppingCopyUrl;
	}
	...
	public String getReturnCopyUrl() {
		return returnCopyUrl;
	}

	public void setReturnCopyUrl(String returnCopyUrl) {
		this.returnCopyUrl = returnCopyUrl;
	}

	public Double getMiaoBiLimit() {
		return miaoBiLimit;
	}

	public void setMiaoBiLimit(Double miaoBiLimit) {
		this.miaoBiLimit = miaoBiLimit;
	}
	...
	public Boolean getIsSendMiaoBi() {
		return isSendMiaoBi;
	}

	public void setIsSendMiaoBi(Boolean isSendMiaoBi) {
		this.isSendMiaoBi = isSendMiaoBi;
	}

	public Double getSendMiaoBiLimit() {
		return sendMiaoBiLimit;
	}

	public void setSendMiaoBiLimit(Double sendMiaoBiLimit) {
		this.sendMiaoBiLimit = sendMiaoBiLimit;
	}
