...
import com.wtshop.util.ReturnKit;

/**
 * Simple Filter that, upon receiving a request, will immediately log-out the
 * currently executing
 * {@link #getSubject(ServletRequest, ServletResponse)
...
public class ShiroLogoutFilter extends AdviceFilter {
	...
	/**
	 * Returns the currently executing {@link Subject}.
	 * This implementation merely defaults to calling {@code SecurityUtils.}
	 * {@link SecurityUtils#getSubject() getSubject()}, but can
	 ...
	 * {@code Subject.}
	 * {@link Subject#getSession(boolean)
