...
public class GoodsAPIController extends BaseAPIController {
	...
	public void list() {
		...
		String attribute_value0 = getPara("attribute_value0");  //1.考点，2 考卷
		String type = getPara("type");//0真题，1模拟题
		String areaId = getPara("areaId");//地区
		String biaoqian = getPara("biaoqian");//标签
		String attribute_value3 = getPara("attribute_value3");//标签
		Integer pageNumber = getParaToInt("pageNumbers", 1);
		Integer pageSize = getParaToInt("pageSizes", 20);
		Pageable pageable = new Pageable(pageNumber, pageSize);
	    Page<Goods> page = goodsService.findPages(attribute_value0,attribute_value3,type,areaId,biaoqian,pageable);
	...
	//去添加页面
	public void shiPinList() {
		Long fenLei = getParaToLong("fenLei");
		List<GroupBuy> groupBuy=groupBuyService.findListProdect(fenLei);

		renderJson(ApiResult.success(groupBuy));
	}
	/**
	 * 详情
