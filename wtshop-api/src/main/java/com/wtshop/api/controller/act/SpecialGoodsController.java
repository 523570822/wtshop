 ...
 */
@ControllerBind(controllerKey = "/api/specialGoods")
@Before({WapInterceptor.class, ErrorInterceptor.class, TokenInterceptor.class})
public class SpecialGoodsController extends BaseAPIController {
...
//1是 ，0否  是否開發票
        ...
        Order order = orderService.createSpecial(Order.Type.special, fuDai, receiver,isInvoice,isPersonal,taxNumber,companyName);
