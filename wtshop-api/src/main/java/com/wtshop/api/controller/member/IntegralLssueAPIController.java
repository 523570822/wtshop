 ...
 *
 */
@ControllerBind(controllerKey = "/api/member/IntegralLssue")
@Before({WapInterceptor.class, ErrorInterceptor.class, TokenInterceptor.class})
public class IntegralLssueAPIController extends BaseAPIController {

    org.slf4j.Logger logger = LoggerFactory.getLogger(IntegralLssueAPIController.class);
    ...
    //    Integer type = getParaToInt("type");
        ...
        Page<IntegralLog> page = integralLogService.findPage(member, pageable );
