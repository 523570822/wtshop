...
public class TuanGouGoodsMessageResult implements Serializable {
    ...
    public List<FightGroup> getFightGroupList() {
        return fightGroupList;
    }

    public void setFightGroupList(List<FightGroup> fightGroupList) {
        this.fightGroupList = fightGroupList;
    }

    private List<FightGroup> fightGroupList;
    ...
    public TuanGouGoodsMessageResult(Integer sotck, Goods goods, String title, Boolean favorite, Page<Consultation> consultationPages
            , Page<Review> review, Long reviewCount, Long positiveCount, Long moderateCount, Long negativeCount, Long imagesCount,
                                     List<Tag> tag, List<Product> productList, String settingShoppingCopyUrl, String certifiedCopyUrl,
                                     String taxExplainUrl, Receiver aDefault, String receiveTime, String freeMoney,GroupBuy groupbuy, List<FightGroup> fightGroupList) {
        this.sotck = sotck;
        this.goods = goods;
        this.title = title;
