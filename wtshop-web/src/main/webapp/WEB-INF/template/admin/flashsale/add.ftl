...
<div class="breadcrumb">
    <a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.flahsale.activity")}
</div>
<form id="inputForm" action="save.jhtml" method="post">
    <table class="input">
        <tr>
            ...
            <td>
                <input type="text" name="flashsale.title" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="beginDate" name="flashsale.begin_date" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" id="endDate" name="flashsale.end_date" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="flashsale.orders" class="text" maxlength="9" />
            </td>
        </tr>
        <tr>
            <th>
