...
<form id="inputForm" action="update.jhtml" method="post">
    ...
    <table class="input">
        ...
        <tr>
            ...
            <td id="positiveImg">
                <img src="${fileServer}${certificates.positiveImg}" layer-src= "${certificates.positiveImg}" height="100"  width="150">
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td id="oppositeImg">
                <img src="${fileServer}${certificates.oppositeImg}" layer-src= "${certificates.oppositeImg}" height="100" width="150">
            </td>
        </tr>
        <tr>
            <th>
