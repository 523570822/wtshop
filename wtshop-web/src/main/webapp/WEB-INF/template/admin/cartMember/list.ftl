...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("Cart.member.list")}
	...
	<form id="listForm" action="list.jhtml" method="post">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "id"] class="current"[/#if] val="id">${message("Footprint.id")}</li>
                    <li[#if pageable.searchProperty == "phone"] class="current"[/#if] val="phone">${message("Footprint.phone")}</li>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="number">${message("Cart.goods.number")}</a>
				</th>
				<th>
			...
			[#list page.list as cartMember]
				<tr>
					...
					<td>
						<a href="view.jhtml?id=${cartMember.id}">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
