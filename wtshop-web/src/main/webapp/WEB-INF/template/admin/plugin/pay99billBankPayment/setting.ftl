...
<title>${message("admin.plugin.pay99billBankPayment.setting")} - Powered By ${setting.siteAuthor}</title>
				...
				<td>
					<span class="fieldSet">
						...
						[#if pluginConfig.getAttribute("logo")?has_content]
							<a href="${fileServer}${pluginConfig.getAttribute("logo")}" target="_blank">${message("admin.common.view")}</a>
						[/#if]
					</span>
				</td>
			</tr>
