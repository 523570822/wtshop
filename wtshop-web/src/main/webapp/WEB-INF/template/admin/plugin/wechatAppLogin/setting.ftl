...
<title>${message("admin.plugin.wechatAppLogin.setting")} - Powered By ${setting.siteAuthor}</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.plugin.wechatAppLogin.setting")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.wechatAppLogin.oauthKey")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.wechatAppLogin.oauthSecret")}:
				</th>
				<td>
