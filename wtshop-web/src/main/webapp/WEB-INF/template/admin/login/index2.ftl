...
<title>${message("admin.login.title")} - Powered By ${setting.siteAuthor}</title>
...
<body>
	<div class="login">
		<form id="loginForm" action="login.jhtml" method="post">
			...
			<table>
				<tr>
					<td width="190" rowspan="2" align="center" valign="bottom">
						<img src="${base}/resources/admin/images/login_logo.gif" alt="WangtianSoft" />
					</td>
					<th>
			...
			<div class="powered">COPYRIGHT © 2017-2020 wangtiansoft.com ALL RIGHTS RESERVED.</div>
			<div class="link">
				<a href="${base}/">${message("admin.login.home")}</a> |
				<a href="http://www.wangtiansoft.com">${message("admin.login.official")}</a> |
				<a href="http://www.wangtiansoft.com">${message("admin.login.bbs")}</a> |
				<a href="http://www.wangtiansoft.com/about.html">${message("admin.login.about")}</a> |
				<a href="http://www.wangtiansoft.com/contact.html">${message("admin.login.contact")}</a> |
				<a href="http://www.wangtiansoft.com/license.html">${message("admin.login.license")}</a>
			</div>
		</form>
	</div>
</body>
