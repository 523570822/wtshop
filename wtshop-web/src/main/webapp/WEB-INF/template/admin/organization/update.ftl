...
<div class="breadcrumb">
    <a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("organization.edit")}
</div>
<form id="inputForm" action="update.jhtml" method="post">
    <input value="${function.parentId}" name="function.parentId" type="hidden"/>
    <input value="${function.id}" name="function.id" type="hidden"/>
    <table class="input">
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="function.name" value="${function.name}" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="function.orders" value="${function.orders}" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
