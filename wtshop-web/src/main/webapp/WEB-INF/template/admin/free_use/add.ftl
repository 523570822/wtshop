...
<form id="inputForm" action="save.jhtml" method="post">
    ...
    <table class="input">
        <tr>
            ...
            <td>
                <input type="text" name="freeUse.title" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="freeUse.introduction" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
					<span class="fieldSet">
						<input type="text" id="path" name="freeUse.jpg" class="text" maxlength="200" />
        ...
        <tr>
            ...
            <td>
					<span class="fieldSet">
                        <input type="hidden"id="product_id" name="freeUse.product_id"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="beginDate" name="freeUse.end_date" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="freeUse.orders" class="text" maxlength="9" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="number" name="freeUse.num" class="text" maxlength="9" />
            </td>
        </tr>
        <tr>
            <th>
