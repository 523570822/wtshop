...
<head>
    ...
    <title>${message("admin.reverseAuction.add")} - Powered By ${setting.siteAuthor}</title>
...
<div class="breadcrumb">
    ...
    <a href="${base}/admin/reverseAuction/list.jhtml">${message("admin.role.reverseGroup")}</a> &raquo; ${message("reverseGroup.add")}
</div>
<form id="inputForm" action="save.jhtml" method="post">
    ...
    <table class="input tabContent">
        <tr>
            ...
            <td>
                <input type="text" name="reverseAuction.title" class="text" maxlength="200"/>
            </td>
        </tr>
        <tr>
            <th>
