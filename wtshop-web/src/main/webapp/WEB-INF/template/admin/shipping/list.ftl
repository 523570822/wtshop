...
<title>${message("admin.shipping.list")} - Powered By ${setting.siteAuthor}</title>
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					...
					<li[#if pageable.searchProperty == "tracking_no"] class="current"[/#if] val="tracking_no">${message("Shipping.trackingNo")}</li>
		...
		<table id="listTable" class="list">
			...
			[#list page.list as shipping]
				<tr>
                    ...
                    <td>
						[#if shipping.order.type == "0"]
                            <span>${message("Order.Type." + shipping.order.typeName)}</span>
						[#else ]
                            <span class="blue">${message("Order.Type." + shipping.order.typeName)}</span>
						[/#if]
                    </td>
					<td>
