...
<title>${message("admin.paymentMethod.edit")} - Powered By ${setting.siteAuthor}</title>
				...
				<td>
					<span class="fieldSet">
						...
						[#if paymentMethod.icon??]
							<a href="${fileServer}${paymentMethod.icon}" target="_blank">${message("admin.common.view")}</a>
						[/#if]
					</span>
				</td>
			</tr>
