...
<body>
	...
	<form id="listForm" action="list.jhtml" method="post">
		<div class="bar">
			<a href="add.jhtml?configId=${configId}" class="iconButton">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="prefix">${message("ticket.list.RemainingQuantity")}</a>
				</th>
                <th>
                    <a href="javascript:;" class="sort" name="product_category_id">${message("ticket.list.PreferenceCategories")}</a>
                </th>
                <th>
                    <a href="javascript:;" class="sort" name="product_product_id">${message("ticket.discountGoods")}</a>
                </th>
				<th>
