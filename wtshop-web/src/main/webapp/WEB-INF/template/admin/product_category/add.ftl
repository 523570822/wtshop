...
<title>${message("admin.productCategory.add")} - Powered By ${setting.siteAuthor}</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
            ...
            <tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="image" name="productCategory.image" class="text" maxlength="200" />
			...
			[#--<tr>--]
				...
				[#--</th>--]
				[#--<td>--]
					[#--<input type="text" name="productCategory.seo_title" title="预留功能,可以不填写" class="text" maxlength="200" />--]
				[#--</td>--]
			[#--</tr>--]
			[#--<tr>--]
				[#--<th>--]
				...
				[#--</th>--]
				[#--<td>--]
					[#--<input type="text" name="productCategory.seo_keywords" title="预留功能,可以不填写" class="text" maxlength="200" />--]
				[#--</td>--]
			[#--</tr>--]
			[#--<tr>--]
				[#--<th>--]
				...
				[#--</th>--]
				[#--<td>--]
					[#--<input type="text" name="productCategory.seo_description" title="预留功能,可以不填写" class="text" maxlength="200" />--]
				[#--</td>--]
			[#--</tr>--]
			[#--<tr>--]
				[#--<th>--]
				...
				[#--</th>--]
				[#--<td>--]
					[#--<input type="text" name="productCategory.orders" title="预留功能,可以不填写" class="text" maxlength="9" />--]
				[#--</td>--]
			[#--</tr>--]
			<tr>
				<th>
