...
<title>${message("admin.productCategory.edit")} - Powered By ${setting.siteAuthor}</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
                <th>
					${message("ProductCategory.image")}:
                </th>
                <td>
					<span class="fieldSet">
						<input type="text" id="image" name="productCategory.image" class="text" value="${productCategory.image}" maxlength="200" />
						<a href="javascript:;" id="filePicker" class="button">${message("admin.upload.filePicker")}</a>
					</span>
					[#if productCategory.image??]
                        <a href="${fileServer}${productCategory.image}" target="_blank">${message("admin.common.view")}</a>
					[/#if]
                </td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" name="productCategory.seo_title" class="text" title="预留功能,可以不填写" value="${productCategory.seoTitle}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="productCategory.seo_keywords" class="text" title="预留功能,可以不填写" value="${productCategory.seoKeywords}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="productCategory.seo_description" class="text" title="预留功能,可以不填写" value="${productCategory.seoDescription}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="productCategory.orders" class="text" title="预留功能,可以不填写" value="${productCategory.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
