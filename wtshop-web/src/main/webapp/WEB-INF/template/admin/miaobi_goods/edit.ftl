...
<form id="inputForm" action="update.jhtml" method="post">
    <input type="hidden" value="${miaobiGoods.id}" name="miaobiGoods.id">
    <table class="input">
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="miaobiGoods.price_miaobi" class="text" maxlength="200" value="${miaobiGoods.priceMiaobi}" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="miaobiGoods.price" class="text" maxlength="200" value="${miaobiGoods.price}" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
					<span class="fieldSet">
                        <input type="hidden"id="goods_id" name="miaobiGoods.goods_id" value="${miaobiGoods.goodsId}"/>
						<input type="text" id="goods_name" class="text" maxlength="200" value="${miaobiGoods.goods.name}" />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="miaobiGoods.orders" class="text" maxlength="9" value="${miaobiGoods.orders}" />
            </td>
        </tr>
        <tr>
            <th>
