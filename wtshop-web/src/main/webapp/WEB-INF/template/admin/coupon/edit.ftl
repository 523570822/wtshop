...
$().ready(function() {
	...
	if(name != null && name != ""){
		...
		$("#productCategory").attr("checked","checked")
	};
		...
		<div class="tabContent">
			<table class="input">
                <tr>
                    ...
                    <td>
                        <input type="text" name="coupon.name"  value="${coupon.name}" class="text" maxlength="200" />
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" id="money" name="coupon.money" class="text"  value="${coupon.money}" maxlength="200" title="满减金额,如需打折券请输入0"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" id="modulus" name="coupon.modulus" class="text"  value="${coupon.modulus}" maxlength="200" title="打折券系数,请在0~10内输入,如需满减券请输入10"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" name="coupon.condition" class="text"  value="${coupon.condition}" maxlength="200" title="使用优惠券的条件金额"/>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" name="coupon.count" class="text" value="${coupon.count}" maxlength="200" title="优惠券发放上限"/>
                    </td>
                </tr>
				<tr>
					<th>
                ...
                <tr>
                    <th>
                        <span class="requiredField"></span>优惠种类:
                    </th>
                    <td>
                        <select id="productCategoryId" name="coupon.product_category_id">
                            <option value="" selected="selected">请选择</option>
							[#list productCategoryTree as productCategory]
                                <option value="${productCategory.id}"[#if productCategory == coupon.productCategory || coupon.product_category_id == 242] selected="selected"[/#if]>
                ...
                <tr>
                    <th>
                        <span class="requiredField"></span>优惠券商品:
                    </th>
                    <td colspan="4">
                        <input type="hidden" id ="product_id" value="${coupon.product_id}" name="coupon.product_id"/>
                        <input type="text" id="product_name" value="${coupon.product.goods.name}"  class="text" maxlength="200" disabled="disabled"/>
                ...
                <tr>
                    ...
                    <td>
					<span class="fieldSet">
						<input type="text" name="coupon.image" class="text"  value="${coupon.image}"  maxlength="200" />
