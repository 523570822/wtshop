...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
        <input class="hidden" name ="couponShare.id"  value="${couponShare.id}"/>
        <ul id="tab" class="tab">
            <li>
        ...
        <table class="input tabContent">
            <tr>
                ...
                <td>
                    <input type="text" name="couponShare.title" class="text" value="${couponShare.title}" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" name="couponShare.content" class="text"   value="${couponShare.content}"/>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    ...
                    <input type="hidden"  id="couponId" name="couponShare.couponId" class="text" value="${couponShare.couponId}"  />
                    <span id="couponTxt">${coupon.name}</span>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" name="couponShare.numLimit" class="text"  value="${couponShare.numLimit}" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" name="couponShare.link" class="text"  value="${couponShare.link}" />
                </td>
            </tr>
