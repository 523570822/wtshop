	...
	<form id="listForm" action="list.jhtml" method="post">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="" name="">标题</a>
				</th>
				<th>
					<a href="javascript:;" class=""  name="">内容</a>
				</th>
                <th>
                    <a href="javascript:;" class="sort" name="">链接</a>
                </th>
                <th>
                    <a href="javascript:;" class="sort" name="">优惠券名称</a>
                </th>
				<th>
					<a href="javascript:;" class="sort" name="">数量限制</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="">当前数量</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" >创建时间</a>
				</th>
                <th>
			...
			[#list page.list as d]
				...
				${d.link}
					...
					<td>
						<a href="edit.jhtml?id=${d.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
