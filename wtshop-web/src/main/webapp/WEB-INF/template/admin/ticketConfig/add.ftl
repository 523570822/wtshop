...
<body>
	...
	<form id="inputForm" action="save.jhtml" method="post">
        ...
        <ul id="tab" class="tab">
            <li>
                <input type="button" value="${message("ticketConfig.baseinfo")}" class="current">
            </li>
        </ul>
        <table class="input tabContent">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ticketconfig.num" class="text"  value="1" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" name="ticketconfig.maxReceiveDay" class="text"  value="7" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ticketconfig.shareLimit" class="text"  value="10" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="begin_date" name="ticketconfig.beginTime"    class="text Wdate begin_date" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" id="endDate" name="ticketconfig.endTime"   class="text Wdate end_date" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" />
                </td>
            </tr>
