...
<body>
	...
	<table class="main">
		<tr>
			<th class="logo">
				<a href="main.jhtml">
					<img src="${base}/resources/admin/images/header_logo.gif" alt="WangtianSoft" />
				</a>
			</th>
			<th>
				...
				<div class="link">
					<a href="http://www.wangtiansoft.com" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://bbs.wangtiansoft.com" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://www.wangtiansoft.com/about.html" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
					<strong>[@shiro.principal name="username" /]</strong>
					${message("admin.main.hello")}!
					<a href="../profile/edit.jhtml" target="iframe">[${message("admin.main.profile")}]</a>
					<a href="/signout" target="_top">[${message("admin.main.logout")}]</a>
				</div>
			</th>
		</tr>
		<tr>
