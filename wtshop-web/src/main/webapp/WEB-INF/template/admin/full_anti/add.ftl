	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input tabContent">
			<tr>
				...
				<td>
					<input type="text" name="fullAnti.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="fullAnti.total_money" class="text" maxlength="200" />
                </td>
            </tr>
		[#--  <tr>
          <th>
  ...
  <tr>
          ...
          <td>
			...
			<tr>
				...
				<td>
					<input type="text" name="fullAnti.orders" class="text" maxlength="9" />
				</td>
			</tr>
		</table>
		<table class="input tabContent">
			<tr>
				<td>
					<textarea id="introduction" name="fullAnti.introduction" class="editor" style="width: 100%;"></textarea>
				</td>
			</tr>
		</table>
		<table class="input">
