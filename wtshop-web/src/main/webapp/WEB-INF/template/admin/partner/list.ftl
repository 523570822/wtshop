...
<title>${message("admin.partner.list")} - Powered By ${setting.siteAuthor}</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.partner.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="post">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="fullName">${message("admin.partner.locale")}</a>
				</th>
				<th>
					<span>${message("admin.partner.status")}</span>
				</th>
				<th>
					<span>${message("admin.common.action")}</span>
				</th>
			</tr>
			[#list page.list as partner]
				<tr>
					<td>
					...
					<td>
						${partner.createDate}
						[#--<span title="${partner.createDate?string("yyyy-MM-dd HH:mm:ss")}">${partner.createDate}</span>--]
					</td>
					<td>
						${partner.fullName}
						[#--<span title="${partner.createDate?string("yyyy-MM-dd HH:mm:ss")}">${partner.createDate}</span>--]
                ...
                [/#if]
					...
					<td>
						<a href="view.jhtml?id=${partner.id}">[${message("admin.common.view")}]</a>
						<a href="edit.jhtml?id=${partner.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
