...
<head>
    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $inputForm.validate({
                rules: {
                    "interest_category.name":"required"
                }
            });
...
<div class="breadcrumb">
    <a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; 添加感兴趣分类
</div>
<form id="inputForm" action="save.jhtml" method="post">
    <table class="input">
        <tr>
            ...
            <td>
                <input type="text" name="interestCategory.name" class="text" maxlength="9" />
            </td>
        </tr>
        <tr>
            <th>
