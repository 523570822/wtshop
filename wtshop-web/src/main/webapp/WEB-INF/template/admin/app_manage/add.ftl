...
<head>
    ...
    <title>${message("appManage.add.title")} - Powered By ${setting.siteAuthor}</title>
...
<div class="breadcrumb">
    <a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("appManage.add.title")}
</div>
<form id="inputForm" action="save.jhtml" method="post"   >
    ...
    <table class="input tabContent">
        <tr>
            ...
            <td>
                <input type="text" name="appManage.appName" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="appManage.appId" class="text" maxlength="200"  readonly="readonly"   value="${appId}" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="appManage.appKey" class="text" maxlength="200"  readonly="readonly"  value="${appKey}" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="appManage.ipWhiteList" class="text" maxlength="200"  "   />
