 ...
 * 
 */
@ControllerBind(controllerKey = "/admin/housekeeper")
public class HousekeeperController extends BaseController {
	...
	public void list() {
		...
		setAttr("page", pages );
		render("/admin/housekeeper/list.ftl");
